...
await page.selectOption('#modeSelect', 'the-voyage');
await page.waitForTimeout(10000);
await page.screenshot({ path: '/tmp/voy-opening.png' });
await page.waitForTimeout(22000);
await page.screenshot({ path: '/tmp/voy-flight.png' });
// also re-check garden with its rebalanced vines
await page.selectOption('#modeSelect', 'growing-garden');
await page.waitForTimeout(40000);
await page.screenshot({ path: '/tmp/garden-vines2.png' });
